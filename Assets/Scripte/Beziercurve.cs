...
public class Beziercurve : MonoBehaviour
{
    ...
    //            Vector3 firstDerivative_1F = GetFirstDerivative_1F();
    //            Vector3 derivative_1F_length = GetCurvePoint(1f) + level_Length * firstDerivative_1F.normalized;
    //            Gizmos.DrawLine(GetCurvePoint(1f), derivative_1F_length);
    //            Handles.Label(derivative_1F_length, "First Derivative " + gameObject.name);
    ...
    //            Vector3 secondDerivative_1F = GetSeccondDerivative_1F();
    //            Vector3 secondDerivative_1F_length = GetCurvePoint(1f) + secondDerivative_1F.normalized * level_Length;
    //            Gizmos.DrawLine(GetCurvePoint(1f), secondDerivative_1F_length);
    //            Handles.Label(secondDerivative_1F_length, "Second Derivative " + gameObject.name);
    ...
    //            // 1 Ableitung
    //            Gizmos.color = Color.blue;
    //            Vector3 firstDerivative_0F = GetFirstDerivative_0F();
    //            Vector3 derivative_0F_length = GetCurvePoint(0f) + level_Length * firstDerivative_0F.normalized;
    //            Gizmos.DrawLine(GetCurvePoint(0f), derivative_0F_length);
    //            Handles.Label(derivative_0F_length, "First Derivative");

    //            // 2. Ableitung
    //            Gizmos.color = Color.yellow;
    //            Vector3 secondDerivative_0F = GetSeccondDerivative_0F();
    //            Vector3 secondDerivative_0F_length = GetCurvePoint(0f) + secondDerivative_0F.normalized * level_Length;
    //            Gizmos.DrawLine(GetCurvePoint(0f), secondDerivative_0F_length);
    //            Handles.Label(secondDerivative_0F_length, "Second Derivative");
    //        }
